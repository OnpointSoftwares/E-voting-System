...
--
-- Host: localhost
-- Generation Time: Jun 17, 2025 at 01:29 PM
...
(1, 'ssvps', 'shadrack@gmail.com', 'pass@123');
...
(20, 'Mohan Sharma', 'Mobile', 'symbol/e3.png', 'Secretary', 5),
(21, 'Rohit Misra', 'Football', 'symbol/s2.png', 'Chairman', 7),
(22, 'Aniket Sharma', 'Camera', 'symbol/e4.png', 'Secretary', 6),
(23, 'Vivek Joshi', 'Helmet', 'symbol/a6.png', 'Chairman', 5),
...
CREATE TABLE `register` (
  ...
  `status` varchar(11) NOT NULL DEFAULT 'not voted'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `register` (`id`, `fname`, `lname`, `idname`, `idnum`, `idcard`, `inst_id`, `dob`, `gender`, `phone`, `email`, `address`, `password`, `verify`, `status`) VALUES
(122, 'vincent', 'Kip', 'Other ID Card', '32445678', 'img/1aliens_plot.png', '23456787', '1999-02-09', 'male', '0702502955', '', '', '123456', 'yes', 'not voted'),
(123, 'vincent', 'Kip', 'Other ID Card', '32445670', 'img/2aliens_plot.png', '23456784', '1999-02-09', 'male', '0738502955', '', '', '', 'yes', 'not voted'),
(126, 'kiprono', 'shadrack', 'Voter Card', '38970592', 'img/3Screenshot_2025-06-09_09_14_24.png', '38970592', '2000-01-12', 'male', '0737591110', '', '', '', 'yes', 'not voted'),
(127, 'vincent', 'kips', 'Voter Card', '37456789', 'img/4aliens_plot.png', '3476980', '1998-01-05', 'male', '0738234567', '', '', '', 'yes', 'not voted'),
(132, 'VINCENT', 'KIPKURUI', 'Voter Card', '37482710', 'img/4cfc.png', '123456709', '2000-06-23', 'male', '0702502952', 'vincentbett@gmail.com', '', '123456', 'yes', 'voted');
